...
‍{{< 
    figure src="./assets/nutribot-notification.png" 
    alt="Image of a phone with a mock-up notification telling the user that a doctor has uploaded a health record." 
    caption="Users expect a greater level of data sharing between healthcare providers and healthtech apps." 
    >}}
...
‍{{< figure src="./assets/diagram_analog-healthcare-model.png" alt="A diagram showing an 'analog' integrated healthcare model where various healthcare practitioners coordinate with a patient." caption="In an Integrated Healthcare Model, a team of professionals coordinate care for a patient." >}}
...
‍{{< 
    figure src="./assets/mockup_health-vault.png" 
    alt="A mock-up of a phone screen with an app showing a user's 'health vault' with settings to manage access to different apps."  
    >}}
...
‍{{< 
    figure src="./assets/diagram_data-silos.png" 
    alt="A diagram showing the user's health data spread across many independent database 'silos'."  
    caption="Healthtech organizations with limited access to patient data will lack a holistic data-picture of patients for training AI models." 
    >}}
‍
...
‍{{< 
    figure src="./assets/diagram_web3-sharing.gif" 
    alt="A diagram showing the user's health data spread across many independent database 'silos'."  
    caption="Companies that contribute to and pull from a common pool of user data will be able to train more personalized AI models and deliver more personalized experiences." 
    >}}
...
----------------------------------------------------------------------------------------------------
This article was written by me and originally published on the [Guidea Blog](https://guidea.com/insights/how-web3-will-shape-the-future-of-the-healthtech-landscape)