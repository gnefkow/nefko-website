...
![](./assets/ux-in-crypto_key-takeaways_799x1024.png)
...
![](./assets/framework_adoption-curve.png)
...
![Displays an image that shows the difference between the "Investing Paradigm" and the "Transacting Paradigm"](./assets/framework_investing-vs-transacting_1024x879.png)Users have very different expectations when working with assets for transactions vs investments. These norms in other financial spaces are fuzzier (and more confusing) in cryptocurrency. 
...
![](./assets/framework_disparate-vs-contained.png)
...
![](./assets/screens_metamask-vs-opensea_.png)
